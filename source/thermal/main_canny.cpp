...
static void Canny(Mat , Mat, int, const char*);
...
int main( int argc, char **argv )
{
	...
	{	
		...
		Canny(thermal_image_r, thermal_image_r, 6, "Edge Map Thermal Image");
		Canny(pi_image, pi_image_gray, 10, "Edge Map Pi Image");
...
static void Canny(Mat image, Mat image_gray, int lowThreshold, const char* windows_name)
{
