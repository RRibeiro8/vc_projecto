...
Mat thermal_image_r, thermal_image_c;
...
{	
	...
	{	
		...
		applyColorMap(thermal_image, thermal_image_c, COLORMAP_JET);

		resize(thermal_image_c, thermal_image_r, pi_image.size());
		
		cvtColor( pi_image, pi_image_gray, COLOR_BGR2GRAY );

		imshow("Pi Image gray", pi_image_gray);
		//imshow("Thermal Image Resize", thermal_image);
		imshow("Thermal Image", thermal_image_r);
